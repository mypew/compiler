...
class Lexer {
  ...
  static get #RULES() {return [
    ...
    {code: 2, name: "число_с_плавающей_точкой", requests: [{request: "nety", alt_name: null}]},
    ...
    {code: 20, name: "синтаксическая_конструкция_затем", requests: [{request: 'then', alt_name: null}]},
